...
public class CheckGroupController {
    ...
    public Result findById(Integer id){
        try{
            ...
            e.printStackTrace();
            return new Result(true,MessageConstant.QUERY_CHECKGROUP_FAIL);//查询失败
        }
    }
    ...
    public Result findCheckItemIdsByCheckGroupId(Integer id){
        try{
            ...
            e.printStackTrace();
            return new Result(true,MessageConstant.QUERY_CHECKITEM_FAIL);//查询失败
        }
    }
    ...
    public Result findAll(){
        try{
            ...
            return new Result(true,MessageConstant.QUERY_CHECKGROUP_SUCCESS,list);//新增成功
        }catch (Exception e){
            e.printStackTrace();
